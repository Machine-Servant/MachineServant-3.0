...
enum FileFieldsEnum {
  ...
  childMarkdownRemark___frontmatter___published = 'childMarkdownRemark.frontmatter.published',
  ...
  childMarkdownRemark___gatsbyPath = 'childMarkdownRemark.gatsbyPath',
...
enum MarkdownRemarkFieldsEnum {
  ...
  frontmatter___featuredImage___childMarkdownRemark___gatsbyPath = 'frontmatter.featuredImage.childMarkdownRemark.gatsbyPath',
  ...
  frontmatter___published = 'frontmatter.published',
  excerpt = 'excerpt',
...
enum SiteFieldsEnum {
  ...
  siteMetadata___social___facebook = 'siteMetadata.social.facebook',
  siteMetadata___social___instagram = 'siteMetadata.social.instagram',
  siteMetadata___social___github = 'siteMetadata.social.github',
  siteMetadata___navigation = 'siteMetadata.navigation',
  siteMetadata___navigation___name = 'siteMetadata.navigation.name',
  siteMetadata___navigation___path = 'siteMetadata.navigation.path',
  port = 'port',
  host = 'host',
...
type SitePageContext = {
  ...
  readonly paginated: Maybe<Scalars['Boolean']>;
  readonly renderTagList: Maybe<Scalars['Boolean']>;
  readonly tag: Maybe<Scalars['String']>;
  readonly id: Maybe<Scalars['String']>;
  readonly parent__relativeDirectory: Maybe<Scalars['String']>;
...
type SitePageContext_xparamsFilterInput = {
  readonly parent__relativeDirectory: Maybe<StringQueryOperatorInput>;
};
...
type SitePageContextFilterInput = {
  ...
  readonly paginated: Maybe<BooleanQueryOperatorInput>;
  readonly renderTagList: Maybe<BooleanQueryOperatorInput>;
...
enum SitePageFieldsEnum {
  ...
  context___totalCount = 'context.totalCount',
  context___paginated = 'context.paginated',
  context___renderTagList = 'context.renderTagList',
  context___tag = 'context.tag',
  context___id = 'context.id',
  context___parent__relativeDirectory = 'context.parent__relativeDirectory',
  context____xparams___parent__relativeDirectory = 'context._xparams.parent__relativeDirectory',
  ...
  pluginCreator___pluginOptions___tailwind = 'pluginCreator.pluginOptions.tailwind',
  ...
  pluginCreator___pluginOptions___options___policy = 'pluginCreator.pluginOptions.options.policy',
  ...
  pluginCreator___pluginOptions___inlineCodeMarker = 'pluginCreator.pluginOptions.inlineCodeMarker',
...
enum SitePluginFieldsEnum {
  ...
  pluginOptions___plugins___pluginOptions___inlineCodeMarker = 'pluginOptions.plugins.pluginOptions.inlineCodeMarker',
  ...
  pluginOptions___tailwind = 'pluginOptions.tailwind',
  ...
  pluginOptions___options___policy = 'pluginOptions.options.policy',
  pluginOptions___options___policy___userAgent = 'pluginOptions.options.policy.userAgent',
  pluginOptions___options___policy___allow = 'pluginOptions.options.policy.allow',
  ...
  pluginOptions___inlineCodeMarker = 'pluginOptions.inlineCodeMarker',
...
type SitePluginPluginOptions = {
  ...
  readonly inlineCodeMarker: Maybe<Scalars['String']>;
...
type SitePluginPluginOptionsFilterInput = {
  ...
  readonly inlineCodeMarker: Maybe<StringQueryOperatorInput>;
...
type SitePluginPluginOptionsOptions = {
  ...
  readonly failOnError: Maybe<Scalars['Boolean']>;
  readonly policy: Maybe<ReadonlyArray<Maybe<SitePluginPluginOptionsOptionsPolicy>>>;
};

type SitePluginPluginOptionsOptionsFilterInput = {
  readonly emitWarning: Maybe<BooleanQueryOperatorInput>;
  readonly failOnError: Maybe<BooleanQueryOperatorInput>;
  readonly policy: Maybe<SitePluginPluginOptionsOptionsPolicyFilterListInput>;
};

type SitePluginPluginOptionsOptionsPolicy = {
  readonly userAgent: Maybe<Scalars['String']>;
  readonly allow: Maybe<Scalars['String']>;
};

type SitePluginPluginOptionsOptionsPolicyFilterInput = {
  readonly userAgent: Maybe<StringQueryOperatorInput>;
  readonly allow: Maybe<StringQueryOperatorInput>;
};

type SitePluginPluginOptionsOptionsPolicyFilterListInput = {
  readonly elemMatch: Maybe<SitePluginPluginOptionsOptionsPolicyFilterInput>;
};
...
type SiteSiteMetadata = {
  ...
  readonly navigation: Maybe<ReadonlyArray<Maybe<SiteSiteMetadataNavigation>>>;
};
...
type SiteSiteMetadataFilterInput = {
  ...
  readonly navigation: Maybe<SiteSiteMetadataNavigationFilterListInput>;
};
...
type SiteSiteMetadataNavigationFilterListInput = {
  readonly elemMatch: Maybe<SiteSiteMetadataNavigationFilterInput>;
};
...
type ErrorPageQuery = { readonly errorImage: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluid_withWebpFragment> }> }> };

type usersevansternprojectsmachineservantmachineservant30SrcgatsbyPagesblogMarkdownRemarkParentFileRelativeDirectoryTsx3899789536QueryVariables = Exact<{
  id: Maybe<Scalars['String']>;
}>;


type usersevansternprojectsmachineservantmachineservant30SrcgatsbyPagesblogMarkdownRemarkParentFileRelativeDirectoryTsx3899789536Query = { readonly markdownRemark: Maybe<(
    Pick<MarkdownRemark, 'id' | 'htmlAst' | 'excerpt' | 'timeToRead'>
    & { readonly parent: Maybe<(
      { readonly __typename: 'File' }
      & Pick<File, 'id' | 'relativeDirectory'>
    ) | { readonly __typename: 'ImageSharp' } | { readonly __typename: 'MarkdownRemark' } | { readonly __typename: 'Directory' } | { readonly __typename: 'Site' } | { readonly __typename: 'SitePage' } | { readonly __typename: 'SitePlugin' } | { readonly __typename: 'SiteBuildMetadata' }>, readonly frontmatter: Maybe<(
      Pick<MarkdownRemarkFrontmatter, 'author' | 'date' | 'keywords' | 'title' | 'tags'>
      & { fromNow: MarkdownRemarkFrontmatter['date'] }
...
type SiteMetaDataQueryQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<(
      Pick<SiteSiteMetadata, 'title' | 'description' | 'author' | 'siteUrl' | 'image' | 'contact' | 'keywords'>
...
type usersevansternprojectsmachineservantmachineservant30SrctemplatesTaggedPostsTsx4240163052QueryVariables = Exact<{
  tag: Maybe<Scalars['String']>;
}>;


type usersevansternprojectsmachineservantmachineservant30SrctemplatesTaggedPostsTsx4240163052Query = { readonly posts: (
